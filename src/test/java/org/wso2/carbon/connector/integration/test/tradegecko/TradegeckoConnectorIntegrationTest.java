...
public class TradegeckoConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    public void setEnvironment() throws Exception {
        ...
        init("tradegecko-connector-1.0.1-SNAPSHOT");
     ...
     */
    @Test(priority = 1, groups = {"wso2.esb"}, description = "Tradegecko {listProducts} integration test with" +
     ...
     */
    @Test(dependsOnMethods = {"testListProductsMandatoryParameters"}, groups = {"wso2.esb"}, description = "Tradegecko" +
            " {getProduct} integration test with mandatory parameters.")
     ...
     */
    @Test(dependsOnMethods = {"testGetProductMandatoryParameters"}, groups = {"wso2.esb"}, description = "Tradegecko" +
            " {getProduct} integration test negative case.")
     ...
     */
    @Test(dependsOnMethods = {"testGetProductNegativeCase"}, groups = {"wso2.esb"}, description = "Tradegecko " +
            "{createInvoice} integration test with mandatory parameters.")
     ...
     */
    @Test(dependsOnMethods = {"testCreateInvoiceMandatoryParameters"}, groups = {"wso2.esb"}, description = "Tradegecko " +
            "{createInvoice} integration test with optional parameters.")
     ...
     */
    @Test(dependsOnMethods = {"testCreateInvoiceOptionalParameters"}, groups = {"wso2.esb"}, description = "Tradegecko" +
            " {createInvoice} integration test negative case.")
     ...
     */
    @Test(dependsOnMethods = {"testCreateInvoiceNegativeCase"}, groups = {"wso2.esb"}, description = "Tradegecko" +
            " {createInvoiceLineItem} integration test with mandatory parameters.")
     ...
     */
    @Test(dependsOnMethods = {"testCreateInvoiceLineItemMandatoryParameters"}, groups = {"wso2.esb"},
            description = "Tradegecko {createInvoiceLineItem} integration test with optional parameters.")
     ...
     */
    @Test(dependsOnMethods = {"testCreateInvoiceLineItemOptionalParameters"}, groups = {"wso2.esb"},
            description = "Tradegecko {createInvoiceLineItem} integration test negative case.")
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "Tradegecko {createStockAdjustment} integration test with optional" +
            " parameters.")
    ...
    @Test(dependsOnMethods = {"testCreateStockAdjustmentWithMandatoryParameters"},
            groups = {"wso2.esb"}, description = "Tradegecko {createStockAdjustmentLineItem} integration test with " +
            "mandatory parameters.")
    ...
    @Test(dependsOnMethods = {"testCreateStockAdjustmentWithMandatoryParameters", "testCreateStockAdjustmentLineItemWithMandatoryParameters"},
            groups = {"wso2.esb"}, description = "Tradegecko {createStockAdjustmentLineItem} integration test " +
            "negative case.")
